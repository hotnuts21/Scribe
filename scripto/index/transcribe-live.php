...
<?php echo flash(); ?>
    ...
    <div id="scripto-transcribe" class="scripto">
        ...
        <div>
          <!-- editor buttons -->
          <p>
            <button id ="head" class="btn btn-mini btn-info" type="button">Heading</button>
            <button id ="lb" class="btn btn-mini btn-info" type="button">Line break</button>
            <button id ="add" class="btn btn-mini btn-info" type="button">Addition</button>
            <button id ="del" class="btn btn-mini btn-info" type="button">Deletion</button>
            <button id ="subst" class="btn btn-mini btn-info" type="button">Substitution</button>
            <button id ="gap" class="btn btn-mini btn-info" type="button">Illegible</button>
            <button id ="sic" class="btn btn-mini btn-info" type="button">SIC</button></p>
          <p>
